...
<Tabs items={['cURL', 'Client JS', 'NodeJS', 'Python', 'Ruby', 'PHP', 'Java', 'GO', 'C']}>
  ...
  <Tab>
    ...
    CURLOPT_POSTFIELDS => array('file'=> new
    CURLFILE('/C:/Users/ghosh/Downloads/lorem-ipsum-2023-05-04-04-26-53.pdf')),
  ...
  <Tab>
    ...
    File("/C:/Users/ghosh/Downloads/lorem-ipsum-2023-05-04-04-26-53.pdf")))
    .build();
  ...
  <Tab>
    ...
    file, errFile1 := os.Open("/C:/Users/ghosh/Downloads/lorem-ipsum-2023-05-04-04-26-53.pdf")
    defer file.Close()
    part1,
