...
- Output Format (You can choose the Output Format of the Extracted Data. The Default is Text)

| Data Type |    Key    | Value | Description                           |
|:---------|:---------:| :---------------- |:--------------------------------------|
| File Object | file | ``File Object`` | The File Object of the PDF File to be Extracted |
| String | outputFormat | ``text`` or ``json`` | The Output Format of the Extracted Data. The Default is ``text`` |
...
### Response
  ...
  <Tab>
    ...
    | String | status | `success` or `error` | Status of the API Request             |
    | Number | timestamp | `1620120000` | Timestamp of the API Request          |
    | Object | bounded_contents | `{Object of Pages with the Identified contents}` | Extracted text
    from the PDF     |
    | Number | Processing Count  | `223` | Number of Words Extracted |
  ...
  {
    {
      "id": "7e7d4357-3653-4ff4-b504-dd37907f8d21",
      "status": "success",
      "timestamp": 1683400807441,
      "content": {
        "page_number(int)": [
          { // identified objects
            "type": "KEY_VALUE_SET" || "PAGE" || "LINE" || "WORD" || "TABLE" || "CELL" || "SELECTION_ELEMENT" || "MERGED_CELL" || "TITLE" || "QUERY" || "QUERY_RESULT" || "SIGNATURE" || "TABLE_TITLE" || "TABLE_FOOTER",
            "score": "Number("float")",
            "content": "Lorem ipsum dolor... Text content of the identified object",
            "RowIndex": "Number: Only for Tables("int")",
            "ColumnIndex": "Number: Only for Tables("int")",
            "RowSpan": "Number: Only for Tables("int")",
            "ColumnSpan": "Number: Only for Tables("int")",
            "id": "STRING_VALUE",
            "Relationships": [ // RelationshipList
              { // Relationship Type: "VALUE" || "CHILD" || "COMPLEX_FEATURES" || "MERGED_CELL" ||
