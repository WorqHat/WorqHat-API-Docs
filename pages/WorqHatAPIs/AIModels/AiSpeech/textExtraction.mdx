...
<Tabs items={['cURL', 'Client JS', 'NodeJS', 'Python', 'Ruby', 'PHP', 'Java', 'GO', 'C']}>
  ...
  <Tab>
    ...
    payload = {}
    files = [
    ('audio', ('230684883-a344c619-a560-4ff5-8b99-b4463a34487b.webm', open
    ('/C:/Users/ghosh/Downloads/230684883-a344c619-a560-4ff5-8b99-b4463a34487b.webm', 'rb'),
    'audio/webm'))
    ]
    headers = {
    'x-api-key': '•••••••',
  ...
  <Tab>
    ...
    CURLOPT_POSTFIELDS => array('audio' => new
    CURLFILE('/C:/Users/ghosh/Downloads/230684883-a344c619-a560-4ff5-8b99-b4463a34487b.webm')),
  ...
  <Tab>
    ...
    RequestBody.create(mediaType, new
    File("/C:/Users/ghosh/Downloads/230684883-a344c619-a560-4ff5-8b99-b4463a34487b.webm")))
    .build();
