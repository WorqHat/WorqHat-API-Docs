...
https://api.worqhat.com/api/ai/images/generate/v2
```
...
<Tabs items={['cURL', 'Client JS', 'NodeJS', 'Python', 'Ruby', 'PHP', 'Java', 'GO', 'C']}>
  <Tab>
    ...
    curl --location 'https://api.worqhat.com/api/ai/images/generate/v2' \
    --header 'x-api-key: •••••••' \
    --header 'x-org-key: •••••••' \
    --data '{
    "height": 512,
  ...
  <Tab>
    ...
    fetch("https://api.worqhat.com/api/ai/images/generate/v2", requestOptions)
  ...
  <Tab>
    ...
    url = URI("https://api.worqhat.com/api/ai/images/generate/v2")
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://api.worqhat.com/api/ai/images/generate/v2',
    ...
    String url = "https://api.worqhat.com/api/ai/images/generate/v2";
    String apiKey = "•••••••";
    String orgKey = "•••••••";
  ...
  <Tab>
    ...
    int main(void)
    {
      CURL * curl;
      CURLcode res;
      char *url = "https://api.worqhat.com/api/ai/images/generate/v2";
      char *api_key = "•••••••";
      char *org_key = "•••••••";
