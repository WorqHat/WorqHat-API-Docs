...
# Image Variations V2 (ImaGen V2)

Text to image generation models are a type of artificial intelligence that can create images
based on textual descriptions. These models use machine learning algorithms to learn the
relationship between text and images, and can generate realistic-looking images that match the
textual description. Now you can use these same models to modify existing images, creating
...
https://api.worqhat.com/api/ai/images/modify/v2
```
...
<Tabs items={['cURL', 'Client JS', 'NodeJS', 'Python', 'Ruby', 'PHP', 'Java', 'GO', 'C']}>
  <Tab>
    ...
    curl --location 'https://api.worqhat.com/api/ai/images/modify/v2' \
    --header 'x-api-key: •••••••' \
    --header 'x-org-key: •••••••' \
  ...
  <Tab>
    ...
    fetch("https://api.worqhat.com/api/ai/images/modify/v2", requestOptions)
    ...
    xhr.open("POST", "https://api.worqhat.com/api/ai/images/modify/v2");
  ...
  <Tab>
    ...
    url = URI("https://api.worqhat.com/api/ai/images/modify/v2")
  ...
  <Tab>
    ...
    CURLOPT_URL => 'https://api.worqhat.com/api/ai/images/modify/v2',
  ...
  <Tab>
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "https://api.worqhat.com/api/ai/images/modify/v2");
